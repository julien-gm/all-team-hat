...
public class CompositionTest {
    ...
    public void testScore() throws IOException {
        ...
        Team t1 = teams.get(0);
        Team t2 = teams.get(1);
        Assert.assertEquals(614.61, composition.getScore(), 0.1);
        ...
        Assert.assertEquals(10.0, t1.getHandlerScore(expectedHandlerScore), 1.0);
        Assert.assertEquals(10.0, t2.getHandlerScore(expectedHandlerScore), 1.0);
    }
    ...
    public void testScoreWithSize() throws IOException {
        ...
        Team t1 = teams.get(0);
        Team t2 = teams.get(1);
        Assert.assertEquals(1196.29, composition.getScore(), 0.1);
        Assert.assertEquals(t1.getPlayers().size(), t2.getPlayers().size());
        ...
        double expectedHandlerScore = teamsGenerator.getNbHandlers() / teams.size();
        Assert.assertEquals(10, t1.getHandlerScore(expectedHandlerScore), 1.0);
        Assert.assertEquals(10, t2.getHandlerScore(expectedHandlerScore), 1.0);
    }
